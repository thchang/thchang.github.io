...
\bullitem Designed and implemented a Python framework for building and deploying multiobjective optimization solvers
...
\tabboxmed{\bf Mathematics skills:}numerical optimization, scientific machine learning \& approximation theory, numerical analysis

\hangafter=1 \hangindent=0.22\textwidth 
\tabboxmed{\bf Computing skills:}high-performance computing, open source software design, data structures and algorithms
