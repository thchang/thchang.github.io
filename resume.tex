...
\hangafter=1 \hangindent=0.22\textwidth 
\tabboxmed{\bf Libraries (expert):}numpy, scipy, jax, OpenMP, BLAS, LAPACK

\hangafter=1 \hangindent=0.22\textwidth 
\tabboxmed{\bf Libraries (proficient):}pandas, scikit-learn, matplotlib, plotly/dash, pytorch, keras, MPI, CUDA
