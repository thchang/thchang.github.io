...
\tagline{Multiobjective Optimization and SciML Researcher + Numerical Software Engineer\\
...
\begin{etaremune}
\item 2022 - Present. { ParMOO}: Python library for parallel multiobjective simulation optimization. Release: 0.3.1\\
...
\item 2017 - Present. { DelaunaySparse}: Interpolation via a sparse subset of the Delaunay triangulation. \\
...
\item 2020 - 2022. { VTMOP}: Solver for blackbox multiobjective optimization problems. \\
...
\item 2019 - 2020. { QAML}: Quantum annealing math library.\\
